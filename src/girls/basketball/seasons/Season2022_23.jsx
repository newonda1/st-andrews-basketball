...
function Season2022_23() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setSeasonRosterEntries(getRosterEntriesForSeason(rostersJson, "2022-23"));
      } catch (err) {
  ...
  const getJerseyNumber = (id) => {
    const seasonJersey = getRosterJerseyNumber(seasonRosterEntries, id);
    if (seasonJersey !== "") return seasonJersey;
  ...
  return (
    <div className="p-4 space-y-10 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-4">2022-23 Season</h1>
