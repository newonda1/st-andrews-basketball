...
const seasonRecap = `St. Andrew's turned a six-player varsity roster into the school's first girls basketball state championship, finishing 23-3 and winning the SCISA Class AA title under head coach Deborah Morrell. The Saints opened the season with only six varsity players: senior Meghan Lowe, juniors Carie Bugos, LeighAnne Evans, and Becca Cooper, freshman Grace Wilkowski, and eighth-grader Mary Wilkowski. Morrell told the Savannah Morning News early in December that the group was already one of her most cohesive teams, and that chemistry became the season's defining edge.
