    ...
    const run = async () => {
      try {
        ...
        const playerSeasonTotals = buildBasketballPlayerSeasonTotals({
          playerGameStats: statsData,
          games: gamesData,
          seasonRosters: seasonRostersData,
          adjustments: adjustmentsData,
        });
        const careerTotals = buildBasketballCareerTotals(
          playerSeasonTotals,
          careerAdjustmentsData
        );

        const rows = careerTotals
          .map((totals) => {
            ...
            return {
              ...
              playerImg: player?.PlayerID ? `/images/girls/basketball/players/${player.PlayerID}.jpg` : null,
            };
          })
  ...
  return (
    <div className="pt-2 pb-10 lg:pb-40 space-y-6 px-4 max-w-6xl mx-auto">
      ...
      <p className="-mt-1.5 text-center text-sm italic text-gray-600">
        View complete career totals for St. Andrew&apos;s girls basketball players with tracked game-log entries
      </p>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="w-full max-w-sm">
          <label htmlFor="girls-basketball-career-player-search" className="sr-only">
          ...
          <div className="flex items-center gap-2 rounded-full border border-gray-300 bg-white px-3 py-1.5 shadow-sm">
            ...
            <input
              id="girls-basketball-career-player-search"
              type="search"
              value={playerQuery}
