      ...
      <div className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="flex items-start gap-4">
              <img
                src="/images/boys/baseball/boys_baseball_icon.png"
                alt="Boys Baseball"
                className="w-20 h-20 object-contain shrink-0"
                loading="lazy"
              />
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  Explore the boys baseball program, including schedules,
                  results, and team information.
                </p>
              </div>
            </div>

            <div className="mt-4 text-sm font-medium text-blue-700">
              View boys baseball &rarr;
            </div>
          </Link>
        </div>
      </div>
