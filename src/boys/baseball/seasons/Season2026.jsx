...
const STATE_PLAYOFF_BRACKET = {
  ...
  games: {
    r1_8_9: {
      top: { teamId: "westfield", seed: 8, score: 2 },
      bottom: { teamId: "brookwood", seed: 9, score: 0 },
      winner: "westfield",
    },
    r1_5_12: {
      top: { teamId: "piedmont", seed: 5, score: 2 },
      bottom: { teamId: "dominionChristian", seed: 12, score: 0 },
      winner: "piedmont",
    },
    r1_7_10: {
      top: { teamId: "tiftarea", seed: 7, score: 2 },
      bottom: { teamId: "stAndrews", seed: 10, score: 0 },
      winner: "tiftarea",
    },
    r1_6_11: {
      top: { teamId: "johnMilledge", seed: 6, score: 2 },
      bottom: { teamId: "lakeview", seed: 11, score: 0 },
      winner: "johnMilledge",
    },
    qf_1: {
      top: { teamId: "valwood", seed: 1 },
      bottom: { teamId: "westfield", seed: 8 },
      note: "Best of 3",
    },
    qf_4: {
      top: { teamId: "pinewood", seed: 4 },
      bottom: { teamId: "piedmont", seed: 5 },
      note: "Best of 3",
    },
    qf_2: {
      top: { teamId: "deerfieldWindsor", seed: 2 },
      bottom: { teamId: "tiftarea", seed: 7 },
      note: "Best of 3",
    },
    qf_3: {
      top: { teamId: "frederica", seed: 3 },
      bottom: { teamId: "johnMilledge", seed: 6 },
      note: "Best of 3",
    },
    sf_top: {
