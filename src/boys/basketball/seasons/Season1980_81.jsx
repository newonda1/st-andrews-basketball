...
function Season1980_81() {
  ...
  const SEASON_ID = 1980; // 1980–81 season (games.json Season field should be 1980)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1980–81 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 1980-81 season felt like an early step forward for St. Andrew&apos;s
              boys basketball. Still competing as the Saints under coach Dave Clay,
              the program reached an even 14-14 record and pushed its win total higher
              than either of the first two seasons.
            </p>
            <p>
              The year did not unfold in a straight line. St. Andrew&apos;s absorbed some
              heavy losses in December, but the team settled in once region play took
              hold. From mid-January into early February, the Saints pieced together a
              strong run with wins over David Emanuel, Robert Toombs, Memorial Day,
              Sea Pines, Oglethorpe, and a sweep of Screven Academy.
            </p>
            <p>
              Bill Sharpley led the scoring with 325 points, Steven Todd added 281,
              and Scott Crymes finished with 178. John Strickland also gave the lineup
              another steady scorer with 161 points, helping St. Andrew&apos;s build the
              kind of balanced core that made this one of the program&apos;s most
              competitive seasons to date.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">14-14</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
