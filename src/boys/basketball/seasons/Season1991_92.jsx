...
function Season1991_92() {
  ...
  const SEASON_ID = 1991; // 1991–92 season (games.json Season field should be 1991)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1991–92 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 1991-92 season was the final year of Michael Strange&apos;s run as
              head coach, and it became the winningest season in school history to
              that point. St. Andrew&apos;s went 21-8, the first Saints team ever to
              break the 20-win mark, and carried that form all the way into the
              postseason.
            </p>
            <p>
              The Saints won 13 of their last 18 games, beat Bulloch Academy three
              times, handled both Robert Toombs and David Emanuel in region play,
              and pushed into March before finally falling to Fullington Academy.
              Along the way, Ray Rogers delivered the first 40-point game in school
              history the year before and somehow raised the bar again here, while
              the team kept finding enough scoring depth to turn close games into
              wins.
            </p>
            <p>
              Rogers, now a senior, broke his own school scoring record again and
              became the first player in school history to top 500 points in a
              season, finishing with an adjusted 570. Jonathan Gephart added an
              adjusted 336 points and set the school rebound record with 242, while
              Ted Saunders scored an adjusted 279. Strange&apos;s final team paired that
              star power with balance and depth, and the result was a true
              breakthrough season.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">21-8</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
          ...
          {seasonTotals.length === 0 ? (
            ...
            <>
              ...
              <p className="mt-1 text-center text-xs leading-relaxed text-gray-600">
                Jonathan Gephart&apos;s displayed 336 points, Ray Rogers&apos; displayed 570 points,
                and Ted Saunders&apos; displayed 279 points reflect the season totals published in a
                newspaper article on February 18, 1992. Their points per game still use only the
                surviving game-by-game box score data.
              </p>
            </>
          )}
        </section>
