          ...
          {seasonTotals.length === 0 ? (
            ...
            <>
              ...
              <p className="mt-1 text-center text-xs leading-relaxed text-gray-600">
                Stewart Helmly&apos;s documented season total was later adjusted to 332 points
                based on a December 28, 1985 newspaper report, but those missing points are
                not assigned to specific games in the underlying box score data.
              </p>
            </>
          )}
        </section>
