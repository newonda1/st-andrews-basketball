...
function Season1990_91() {
  ...
  const SEASON_ID = 1990; // 1990–91 season (games.json Season field should be 1990)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1990–91 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              Michael Strange&apos;s second season brought a major jump forward. St.
              Andrew&apos;s finished 12-14, nearly quadrupling its win total from the
              year before, and the Saints developed into one of the most explosive
              offensive teams the program had seen to that point.
            </p>
            <p>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">12-14</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
