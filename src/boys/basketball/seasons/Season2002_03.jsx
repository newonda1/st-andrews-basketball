...
function Season2002_03() {
  ...
  const SEASON_ID = 2002; // 2002–03 season (games.json Season field should be 2002)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">2002–03 Season</h1>
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              ...
              look of a team that could make a deep championship push.
            </p>
            <p>
              Patrick Burns was at the center of that promise. He still finished
              with 142 points despite suffering the season-ending knee injury that
              changed the direction of the year, and before that setback he looked
              like one of the most dangerous players on the roster. Losing him was
              a brutal blow to a team that had the talent to picture itself playing
              for a state championship.
            </p>
            <p>
              Even after the injury, St. Andrew&apos;s stayed dangerous because the
              supporting cast was so strong. Josh Smith poured in 285 points, Cam
              Aldrich scored 263, Davy Clay added 253, and Jeff Smith finished with
              233. Sophomores Clay, Beau Hinton, and Jeff Smith were already
              growing into the group that would win a state championship two years
              later, which is part of why this season still feels like one of the
            ...
            <p>
              ...
              believe it might have ended with a championship banner.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">19-5</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
            ...
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-lg font-semibold text-gray-900">19 Wins</dd>
            </div>
          </dl>
        </div>
      </section>
