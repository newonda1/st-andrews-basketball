...
function Season2000_01() {
  ...
  const SEASON_ID = 2000; // 2000–01 season (games.json Season field should be 2000)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">2000–01 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 2000-01 season opened a short but important coaching chapter at
              St. Andrew&apos;s. It was Karl Demasi&apos;s first of two years as head coach,
              and his first team quickly pushed the program back into the center of
              the SCISA postseason picture. The Lions finished 16-11, claimed a
              third straight region championship, and made a return run to the state
              final four.
            </p>
            <p>
              The scoring spread in the surviving archive shows how balanced that
              team could be. Toby Specht led the way with 472 points, Jeff Smith
              added 273, Patrick Burns scored 238, and Justin Dixon contributed 205.
              St. Andrew&apos;s was not leaning on a single player every night; Demasi&apos;s
              first team had several reliable scoring options and enough depth to
              sustain a long season through region play and into March.
            </p>
            <p>
              The postseason made the year stand out. By winning the region title
              for the third consecutive season, the Lions showed that the program&apos;s
              late-1990s rise had not faded after the 1997-98 state championship.
              The playoff push carried them all the way to the state final four,
              the third such appearance in school history and the first since that
              title-winning 1997-98 team.
            </p>
            <p>
              This season also feels like a reset in the archive itself. For
              2000-01, the surviving source preserves player scoring for every game
              on the schedule but does not carry the fuller box-score detail that
              exists for some later seasons. Even with that lighter record, Demasi&apos;s
              debut season still comes through clearly as one of the stronger years
              of the era and an important bridge between the championship teams of
              the late 1990s and the next phase of the program.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">16-11</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
            ...
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-lg font-semibold text-gray-900">Final Four</dd>
            </div>
          </dl>
        </div>
      </section>
          ...
          {seasonTotals.length === 0 ? (
            ...
            <>
              ...
              <p className="mt-1 text-center text-xs leading-relaxed text-gray-600">
                This season currently includes scoring by game only. Other box-score categories were
                not preserved in the surviving source, so the player table reflects points and
                points per game from the season scoring archive, and GP/PPG effectively track games
                in which a player recorded points.
              </p>
            </>
          )}
        </section>
