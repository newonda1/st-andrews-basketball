...
function Season1979_80() {
  ...
  const SEASON_ID = 1979; // 1979–80 season (games.json Season field should be 1979)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1979–80 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              St. Andrew&apos;s entered the 1979-80 season still in the early work of
              building a program and identity of its own. This was only the second
              boys basketball team to compete under the St. Andrew&apos;s name, and the
              Saints were leaning on a mix of returning contributors and a larger wave
              of new faces as the school settled into its new era.
            </p>
            <p>
              The overall record finished at 8-18, but the season had more fight in it
              than that number alone suggests. St. Andrew&apos;s opened with a win over
              Beaufort Academy, had to grind through a difficult middle stretch, then
              found some late momentum in February with playoff victories over Robert
              Toombs Christian Academy and David Emanuel Academy.
            </p>
            <p>
              Val Prescott led the scoring with 310 points, while Mike Brown added 208
              and Garrett Weeks scored 178. Even in a season with more losses than
              wins, that trio helped give the young Saints another foundation year and
              showed the program could still make noise when the postseason arrived.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">8-18</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
