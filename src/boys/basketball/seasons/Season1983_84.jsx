      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 1983-84 season marked another coaching change for St. Andrew&apos;s, with
              Joel Smoker taking over the Saints. The team opened the winter with real
              momentum, winning four of its first five games and looking capable of
              carrying that start deep into region play.
            </p>
            <p>
