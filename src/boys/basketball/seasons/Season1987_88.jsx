        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              ...
              Hubbard&apos;s first year as head coach, St. Andrew&apos;s climbed to a
              14-8 record and put together one of the school&apos;s strongest seasons
              of the 1980s. The Saints were steadier from the start, tougher in
              region play, and much more comfortable winning games in a variety of
              ways.
            </p>
            <p>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            ...
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-lg font-semibold text-gray-900">Em Hubbard</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
