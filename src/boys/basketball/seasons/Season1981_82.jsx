...
function Season1981_82() {
  ...
  const SEASON_ID = 1981; // 1981–82 season (games.json Season field should be 1981)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1981–82 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 1981-82 season opened a new chapter for St. Andrew&apos;s boys basketball
              with Ron Lassiter taking over as head coach. The Saints finished 12-13,
              hovering around .500 for most of the winter and staying competitive in a
              season filled with close games.
            </p>
            <p>
              St. Andrew&apos;s never completely ran away from the schedule, but it kept
              answering tough stretches. The Saints split their early holiday games,
              swept Screven Academy, earned region wins over Robert Toombs Christian
              Academy and David Emanuel Academy, and closed the year with a postseason
              win over Robert Toombs in a 59-57 nail-biter.
            </p>
            <p>
              Danny Wall led the team with 199 points, John Strickland scored 184,
              Bill Sharpley added 151, and Steven Todd finished with 134. That core
              gave St. Andrew&apos;s a steady offensive base as the program moved into its
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">12-13</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
