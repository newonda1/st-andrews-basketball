...
function Season1994_95() {
  ...
  const SEASON_ID = 1994; // 1994–95 season (games.json Season field should be 1994)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">1994–95 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              Dennis Frisco&apos;s only season as head coach came in one of the most
              fragmented years in the archive. Six early games survive only as
              results with no dates, opponents, or box scores, and another win late
              in the season is preserved only as a line on the schedule. That makes
              1994-95 one of the hardest St. Andrew&apos;s teams to fully reconstruct,
              and the final 5-17 record reflects how difficult the winter was on the
              floor as well.
            </p>
            <p>
              What the archive does preserve clearly is how much of the offense fell
              to Kareem Beasley and Leigh Smith. Newspaper summaries push Beasley to
              a displayed 367 points and 56 rebounds and Smith to a displayed 265
              points and 58 rebounds, totals that reach well beyond the surviving
              box scores. Those adjusted numbers show how heavily St. Andrew&apos;s had
              to lean on them while the roster tried to regroup after the losses
              from the championship-era teams immediately before this season.
            </p>
            <p>
              Beasley&apos;s displayed total is especially important in the bigger story
              of the program. Even in a losing season, it marked another major step
              in the rise of a player who would go on to become one of St.
              Andrew&apos;s all-time leading scorers. Smith&apos;s displayed 265 points gave
              the team a second dependable scorer whenever surviving records let us
              see the full shape of a night.
            </p>
            <p>
              The season never found steady footing in the standings, but it still
              matters as a bridge year. It closed Frisco&apos;s brief one-year chapter on
              the sideline and kept Beasley at the center of the program&apos;s next era,
              even if so much of the statistical record now has to be pieced back
              together from newspapers instead of full box scores.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">5-17</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500">Coach</dt>
              <dd className="text-lg font-semibold text-gray-900">Dennis Frisco</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500">Notable</dt>
              <dd className="text-lg font-semibold text-gray-900">Beasley 367</dd>
            </div>
          </dl>
        </div>
      </section>
          ...
          {seasonTotals.length === 0 ? (
            ...
            <>
              ...
              <p className="mt-1 text-center text-xs leading-relaxed text-gray-600">
                Displayed season totals reflect the full archival summary sheet for 1994-95,
                including newspaper-adjusted totals for Kareem Beasley and Leigh Smith where
                games or box scores are missing. Points per game still uses only the surviving
                game-by-game box score data, so the displayed scoring totals do not reconcile
                directly to the visible box-score points for this season.
              </p>
            </>
          )}
        </section>
