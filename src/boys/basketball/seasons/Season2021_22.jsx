      ...
      <section className="space-y-4">
        ...
        <div className="text-gray-800 leading-relaxed">
          <p className="mb-3 leading-relaxed">
            The 2021–22 St. Andrew's boys basketball team delivered one of the
            program's signature seasons, finishing {seasonSummary.wins}-{seasonSummary.losses}{" "}
            overall and a perfect {seasonSummary.regionWins}-{seasonSummary.regionLosses}{" "}
            in region play. Under head coach Mel Abrams Jr., the Lions paired a deep,
            balanced roster with a defense that held opponents to {seasonSummary.pointsAgainst}{" "}
            total points across 29 games.
          </p>

          <p className="mb-3 leading-relaxed">
            St. Andrew's controlled Region 2AAA from start to finish, then backed it
            up in the region tournament with wins over Pinewood Christian and Frederica.
            That run sent the Lions into the GISA Class AAA state tournament as the
            No. 3 seed with momentum and a championship-level identity already in place.
          </p>

          <p className="mb-3 leading-relaxed">
            The state tournament became a four-game championship march: Young Americans
            Christian, Holy Spirit Prep, Southland Academy, and finally John Milledge
            Academy. The Lions closed the season with a 49–47 win in the title game,
            securing the 2022 GISA Class AAA state championship.
          </p>
        </div>
      </section>
