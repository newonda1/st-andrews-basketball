...
function Season2008_09() {
  ...
  const SEASON_ID = 2008; // 2008–09 season (games.json Season field should be 2008)
  ...
  return (
    <div className="pt-1 pb-4 space-y-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-0">2008–09 Season</h1>
      ...
      <section className="max-w-4xl mx-auto space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
          <div className="space-y-3 text-gray-800 leading-relaxed">
            <p>
              The 2008-09 season closed Dave Clay&apos;s five-year return to the St.
              Andrew&apos;s bench. Clay had also coached the first three years in school
              history, so his second stint connected two very different eras of the
              program. His final team finished 7-20 during a difficult stretch for
              the Lions, but the season still carried important individual stories
              and a group of players who kept competing through a demanding winter.
            </p>
            <p>
              Jeffrey Gonzalez led the team with 194 points, Harry Jozefczyk added
              215, Jon Hope scored 148, Jared Howard finished with 141, and Taylor
              Miller contributed 152. Even in a season with more losses than wins,
              St. Andrew&apos;s was not short on players willing to take on big
              offensive roles, and that core helped the team stay competitive in
              several close games.
            </p>
            <p>
              The broader context of the season matters too. These were hard years
              for the program overall, and 2008-09 came at the end of that run. But
              the story of the year is not only the record. It is also about a team
              that kept showing up, a veteran coach whose ties to the school ran
              back to the beginning, and a group that tried to steady the program
              before the next chapter began.
            </p>
            <p>
              In that sense, 2008-09 reads as a closing chapter. It marked the end
              of Clay&apos;s second tenure as head coach, tied the modern program back
              to its earliest teams, and carried St. Andrew&apos;s to the edge of a new
              phase that would eventually rebuild the program&apos;s footing.
            </p>
          </div>
          ...
          <dl className="grid grid-cols-3 gap-3 text-center md:w-64 md:grid-cols-1">
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-xl font-bold text-gray-900">7-20</dd>
            </div>
            <div className="border border-gray-200 rounded-lg px-3 py-2">
            ...
            <div className="border border-gray-200 rounded-lg px-3 py-2">
              ...
              <dd className="text-lg font-semibold text-gray-900">Final Clay Season</dd>
            </div>
          </dl>
        </div>
      </section>
          ...
          {seasonTotals.length === 0 ? (
            ...
            <>
              ...
              <p className="mt-1 text-center text-xs leading-relaxed text-gray-600">
                ...
                not preserved in the surviving source, and the team scoring line on the season sheet
                does not fully reconcile with the player total row. The player table follows the
                season player totals ledger.
              </p>
            </>
          )}
        </section>
